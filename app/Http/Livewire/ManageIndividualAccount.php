...
class ManageIndividualAccount extends Component
{
    ...
    public function approve()
    {
        ...
        $this->emit('flashMessage', __(':account has been approved.', ['account' => $this->individual->name]), __('Account has been approved.', [], 'en'));
    }
    ...
    public function suspend()
    {
        ...
        $this->emit('flashMessage', __(':account has been suspended.', ['account' => $this->individual->name]), __('Account has been suspended.', [], 'en'));
    }
    ...
    public function unsuspend()
    {
        ...
        $this->emit('flashMessage', __('The suspension of :account has been lifted.', ['account' => $this->individual->name]), __('The suspension has been lifted.', [], 'en'));
    }
}
