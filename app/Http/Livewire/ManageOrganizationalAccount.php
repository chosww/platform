...
class ManageOrganizationalAccount extends Component
{
    ...
    public function approve()
    {
        ...
        $this->emit('flashMessage', __(':account has been approved.', ['account' => $this->account->getTranslation('name', locale())]), __('An organization has been approved.', [], 'en'));
    }
    ...
    public function suspend()
    {
        ...
        $this->emit('flashMessage', __(':account and its users have been suspended.', ['account' => $this->account->getTranslation('name', locale())]), __('An organization and its users have been suspended.', [], 'en'));
    }
    ...
    public function unsuspend()
    {
        ...
        $this->emit('flashMessage', __('The suspension of :account and its users has been lifted.', ['account' => $this->account->getTranslation('name', locale())]), __('The suspension of an organization and its users has been lifted.', [], 'en'));
    }
}
